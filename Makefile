...
SRC_DIRS += src/pc/bingo src/pc/bingo/offline #src/pc/bingo/discord
ASM_DIRS :=
...
$(EXE): $(O_FILES) $(MIO0_FILES:.mio0=.o) $(SOUND_OBJ_FILES) $(ULTRA_O_FILES) $(GODDARD_O_FILES) $(BUILD_DIR)/$(DISCORD_SDK_LIBS)
